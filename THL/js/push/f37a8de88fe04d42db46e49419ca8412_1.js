!(function(t, e) {
        ...
        T = u(function(t) {
            ...
            (t.exports = function(t, r, o, i) {
                ...
                s && (E(o, "name") || g(o, "name", r)),
                    t[r] !== o &&
                    (s && (E(o, e) || g(o, e, t[r] ? "" + t[r] : n.join(String(r)))),
                        t === f ?
                        (t[r] = o) :
                        i ?
                        t[r] ?
            ...
            return function(e, u, f) {
                for (
                    var h,
                        ...
                        v = C(d.length),
                        b = 0,
                        m = r ? c(e, v) : n ? c(e, 0) : void 0; v > b; b++
                )
    ...
    var st = "FirebaseError",
        ...
        ct = (function() {
            return function(t, e) {
                if (((this.code = t), (this.message = e), at))
    ...
    !(function(t) {
        ...
        (e.prototype.compress_ = function(t, e) {
            ...
            for (n = 0; n < 80; n++) {
                n < 40 ?
                    n < 20 ?
                    ((i = f ^ (c & (u ^ f))), (s = 1518500249)) :
                    ((i = c ^ u ^ f), (s = 1859775393)) :
                    n < 60 ?
                    ((i = (c & u) | (f & (c | u))), (s = 2400959708)) :
                    ((i = c ^ u ^ f), (s = 3395469782));
        ...
        (e.prototype.update = function(t, e) {
            if (null != t) {
                void 0 === e && (e = t.length);
                for (
                    var r = e - this.blockSize, n = 0, o = this.buf_, i = this.inbuf_; n < e;
            ...
            (t.prototype.subscribe = function(t, e, r) {
                ...
                void 0 ===
                    (n = (function(t, e) {
                        ...
                        t :
                        { next: t, error: e, complete: r }).next && (n.next = pt),
        ...
        vt = (function() {
            ...
            return (
                ...
                (t.prototype._getService = function(t, e) {
                    if (
                        (void 0 === e && (e = dt),
                            ...
                            this.services_[t] || (this.services_[t] = {}), !this.services_[t][e])
                    ) {
                        var r = e !== dt ? e : void 0,
                ...
                (t.prototype.checkDestroyed_ = function() {
                    this.isDeleted_ && bt("app-deleted", { name: this.name_ });
                }),
                t
            );
        })();
    ...
    var mt = new ut("app", "Firebase", {
        ...
        _t = (function t() {
            var e = {},
                ...
                o = {
                    ...
                    initializeApp: function(t, r) {
                        if (
                            (void 0 === r && (r = {}), "object" != typeof r || null === r)
                        ) {
                            var n = r;
                            r = { name: n };
                        }
                        ...
                        var s = i.name;
                        ("string" == typeof s && s) || bt("bad-app-name", { name: s + "" }),
                            lt(e, s) && bt("duplicate-app", { name: s });
                        var c = new vt(t, i, o);
                    ...
                    INTERNAL: {
                        registerService: function(t, e, a, c, u) {
                            r[t] && bt("duplicate-service", { name: t }),
                                (r[t] = e),
                                c &&
                                ((n[t] = c),
                            ...
                            var f = function(e) {
                                return (
                                    void 0 === e && (e = i()),
                                    "function" != typeof e[t] &&
                                    bt("invalid-app-argument", { name: t }),
                                    e[t]()
                                );
                            };
                            return (
            ...
            function i(t) {
                return lt(e, (t = t || dt)) || bt("no-app", { name: t }), e[t];
            }
        ...
        wt = Object.freeze({ default: _t, firebase: _t });
...
!(function(e, t) {
    ...
    try {
                            ...
                            try {
                                ...
                                switch (((r = 0), i && (o = [0, i.value]), o[0])) {
                                    ...
                                    case 7:
                                        ...
                                        continue;
                                    default:
                                        if (!(i = (i = s.trys).length > 0 && i[i.length - 1]) &&
                                            (6 === o[0] || 2 === o[0])
                                        ) {
                                            s = 0;
                                            continue;
            ...
            r(t, e),
                ...
                (t.prototype.update = function(e, t) {
                    if (null != e) {
                        void 0 === t && (t = e.length);
                        for (
                            var n = t - this.blockSize, r = 0, i = this.buf_, o = this.inbuf_; r < t;
        ...
        function y(e, t) {
            ...
            for (
                var n = new DataView(e), r = new DataView(t), i = 0; i < e.byteLength; i++
            )
                            ...
                            switch (s.label) {
                                case 0:
                                    ...
                                    (o =
                                        ...
                                        "&encryption_auth=" +
                                        i),
                                    n !== T && ((a = I(n)), (o += "&application_pub_key=" + a)),
                                ...
                                case 1:
                                    return (
                                        s.trys.push([1, 4, , 5]), [4, fetch(S + "/fcm/connect/subscribe", u)]
                                    );
                                case 2:
                            ...
                            switch (s.label) {
                                case 0:
                                    ...
                                    (c =
                                        ...
                                        "&encryption_auth=" +
                                        a),
                                    i !== T && ((u = I(i)), (c += "&application_pub_key=" + u)),
                                ...
                                case 1:
                                    return (
                                        s.trys.push([1, 4, , 5]), [4, fetch(S + "/fcm/connect/subscribe", f)]
                                    );
                                case 2:
                                    return [4, s.sent().json()];
                                case 3:
                    ...
                    return o(this, void 0, void 0, function() {
                        ...
                        return s(this, function(s) {
                            switch (s.label) {
                                ...
                                case 1:
                                    return (
                                        s.trys.push([1, 4, , 5]), [4, fetch(S + "/fcm/connect/unsubscribe", o)]
                                    );
                                case 2:
                                    return [4, s.sent().json()];
                                case 3:
                    ...
                    (e.prototype.getToken = function() {
                        return o(this, void 0, void 0, function() {
                            ...
                            return s(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return "granted" !== (e = this.getNotificationPermission_()) ?
                                            "denied" === e ?
                                            [2, Promise.reject(g.create(b.NOTIFICATIONS_BLOCKED))] :
                        ...
                        return o(this, void 0, void 0, function() {
                            ...
                            return s(this, function(s) {
                                switch (s.label) {
                                    ...
                                    case 2:
                                        return (
                                            s.sent(), [4, this.vapidDetailsModel.saveVapidDetails(e.scope, n)]
                                        );
                                    case 3:
                                        return s.sent(), [2, i];
                                    case 4:
                        ...
                        return o(this, void 0, void 0, function() {
                            ...
                            return s(this, function(o) {
                                switch (o.label) {
                                    ...
                                    case 2:
                                        return (
                                            o.sent(), [4, this.vapidDetailsModel.saveVapidDetails(e.scope, n)]
                                        );
                                    case 3:
                    ...
                    return o(this, void 0, void 0, function() {
                        ...
                        return s(this, function(i) {
                            switch (i.label) {
                                ...
                                case 1:
                                    return i.sent() ?
                                        t.notification || this.bgMessageHandler ?
                    ...
                    return o(this, void 0, void 0, function() {
                        ...
                        return s(this, function(i) {
                            switch (i.label) {
                                ...
                                case 3:
                                    return (
                                        i.trys.push([3, 5, , 8]), [4, e.pushManager.getSubscription()]
                                    );
                                case 4:
                                    return i.sent(), [3, 8];
                                case 5:
                                ...
                                case 5:
                                    return r ?
                                        (delete t.notification,
                                            (i = K(E.NOTIFICATION_CLICKED, t)), [2, this.attemptToMessageClient_(r, i)]) :
                                        [2];
                            }
                        });
                    });
                ...
                (t.prototype.getSWRegistration_ = function() {
                    ...
                    return this.registrationToUse ?
                        ...
                        ((this.registrationToUse = null),
                            ...
                            .register("", { scope: "/sendpulse-fb-messaging-push-scope" })
                            .catch(function(e) {
...
!(function(i, s) {
    ...
    var e = "function",
                    ...
                    for (n = a = 0; n < c.length && !l;)
                        if ((l = c[n++].exec(i)))
                            for (d = 0; d < m.length; d++)
                                (w = l[++a]),
                                typeof(t = m[d]) === o && t.length > 0 ?
                                2 == t.length ?
                                typeof t[1] == e ?
                                (this[t[0]] = t[1].call(this, w)) :
                                (this[t[0]] = t[1]) :
                                3 == t.length ?
                                typeof t[1] !== e || (t[1].exec && t[1].test) ?
                                (this[t[0]] = w ? w.replace(t[1], t[2]) : s) :
                                (this[t[0]] = w ? t[1].call(this, w, t[2]) : s) :
                                4 == t.length &&
                                (this[t[0]] = w ?
        ...
        v = function(e, o) {
            if (("object" == typeof e && ((o = e), (e = s)), !(this instanceof v)))
    ...
    (v.VERSION = "0.7.18"),
    (v.BROWSER = { NAME: n, MAJOR: "major", VERSION: t }),
    ...
    (v.ENGINE = { NAME: n, VERSION: t }),
    (v.OS = { NAME: n, VERSION: t }),
    i && (i.UAParser = v);
})("object" == typeof window ? window : this);
oSpP = !1;
var oSpPOptions = {
    sAppUrl: "https://ubix.network",
    sAppUrlShow: "https://ubix.network",
    sOrigUrl: "https://ubix.network",
    sOrigFFUrl: "https://ubix.network",
    sSubscribeUrl: "https://ubix.spulse.net",
    sSubscribeFFUrl: "https://ubix.spulse.net",
    ...
    bAutoSubscribe: true,
    sAppKey: "f37a8de88fe04d42db46e49419ca8412",
    prompt_settings: "",
    prompt_title: "",
    prompt_text: "",
    prompt_description: "-",
    prompt_settings_whithout_sw: '{"title":"","text":"Allow ubix.network to send web push notifications to your desktop.","style":"sp-popover","textcolor":"#222222","backgroundcolor":"#ffffff","buttoncolor":"#31b58e","iconcolor":"","btncolor":"","allowbtntext":"Allow","disallowbtntext":"Don\'t allow","btn_lang":"en","visit_number":1,"icon":"/files/push/7650374/websites/f37a8de88fe04d42db46e49419ca8412/icons/1b5301ecec334.png"}',
    currentDB: null,
    timeSend: null,
    newWindow: null,
    parentEvent: null,
    ...
    bMobileEnabled: true,
    show_splogo: "1",
    spdomain_website: "https://sendpulse.com/webpush-powered-by-sendpulse?sn=c3RydWlqay5pdA%3D%3D&from=7650374",
    styles_prefix: "sp",
    aPoweredbyLabel: {
...
function oPromptPush() {
    ...
    (this.start = function() {
        if (!oSpP.detectSite())
            return oSpP.log("Application allowed only for " + e), !1;
        if ("iOS" == oSpP.detectOs())
            return oSpP.log("Application can not work on iOS"), !1;
        if (((u = oSpP.detectOs()), !U && ("iOS" == u || "Android" == u)))
        ...
        if (n && F)
            if (P)
                            ...
                            if (void 0 === e.target.result)
                                oSpP.startDelayedSubscription(function() {
                                    oSpP.startSubscription(),
                                        ("chrome" != l && "firefox" != l && "opera" != l) ||
                                        oSpP.checkIsPopUpWindow() ||
                ...
                for (
                    var r = document.querySelectorAll("." + B + "_notify_prompt"), p = 0; p < r.length; p++
                )
                    r[p].addEventListener("click", function() {
                        oSpP.startSubscription();
                    });
            }
        else if (
            (window.addEventListener(
                    "message",
                    function(e) {
                        e.origin.toLowerCase() == s.toLowerCase() &&
                            "string" == typeof e.data &&
                            ("initend" == e.data ?
                                clearInterval(M) :
                                "closeme" == e.data &&
                                (I.close(), oSpP.storeSubscription(e.data)));
                    }, !1
                ),
                P)
        )
            ...
            for (
                r = document.querySelectorAll("." + B + "_notify_prompt"), p = 0; p < r.length; p++
            )
                r[p].addEventListener("click", function() {
                    oSpP.getDbValue("SPIDs", "PromptClosed", function(e) {
                ...
                function(e) {
                    if (oSpP.detectOrigin(e.origin) && "string" == typeof e.data)
                        ...
                        2 == (t = e.data.split("|")).length &&
                            ((O = t[1]),
                                localStorage.setItem("source_url", O), !0,
                                oSpP.startSubscription(),
                                oSpP.isServiceWorkerChromeSupported() && oSpP.showPushLabel());
                    ...
                    navigator.serviceWorker.getRegistrations().then(function(e) {
                            if (e)
                                for (var t = 0; t < e.length; t++)
                                    e[t].active &&
                                    -1 !=
                                    e[t].active.scriptURL.indexOf(B + "-push-worker.js") &&
                                    e[t].unregister();
                        }),
                        oSpP.isServiceWorkerChromeSupported() &&
    ...
    (this.detectSite = function() {
        var o = !(-1 ===
            ...
            .indexOf(oSpP.clearDomain(e.toLowerCase()))
        );
        return (
            o ||
            (o = !(-1 ===
            ...
            (o = !(-1 ===
                oSpP
                .clearDomain(window.location.href.toLowerCase())
                .indexOf(oSpP.clearDomain(s.toLowerCase()))
            )),
            o
        );
    }),
    (this.detectOrigin = function(e) {
        return !(-1 ===
            ...
            .indexOf(oSpP.clearDomain(o.toLowerCase()))
        );
    }),
    ...
    (this.checkCookie = function(e) {
        for (
            var t = e + "=", o = document.cookie.split(";"), i = 0; i < o.length; i++
        ) {
            for (var r = o[i];
    ...
    (this.doActionsWithPermissions = function(e) {
        ...
        P
            ...
            (oSpP.closePromptHelpText(!0), oSpP.sendPromptStat("prompt_denied")) :
            "default" == e ?
    ...
    (this.registerChrome = function() {
        navigator.serviceWorker
            .register("/" + B + "-push-worker-fb.js", { updateViaCache: "none" })
            .then(function(e) {
                e.installing ?
    ...
    (this.checkIsServiceWorkerExitsAndInitPrompt = function(e) {
        ...
        try {
            ...
            t.open("GET", "/" + B + "-push-worker-fb.js"),
                (t.onload = function(e) {
                    (F = 4 == t.readyState && 200 == t.status),
                    void 0,
                    oSpP.initPrompt();
                }),
                t.send(null),
    ...
    (this.checkSafariPermission = function(e) {
        oSpP.log("[DD] Permissions: " + e.permission),
            ...
            (P ? oSpP.closePromptHelpText(!1) : oSpP.closeCustomPrompt(!1),
                (C = !0),
                oSpP.getDbValue("SPIDs", "PromptShowed", function(e) {
                    void 0 === e.target.result ?
                        (oSpP.sendPromptStat("prompt_showed"),
                            ...
                            11 == t.code &&
                                navigator.serviceWorker.getRegistrations().then(function(t) {
                                    for (var o = 0; o < t.length; o++)
                                        (-1 ==
                                            t[o].active.scriptURL.indexOf(
                                                "OneSignalSDKWorker.js"
                                            ) &&
                                            -1 == t[o].active.scriptURL.indexOf("pushcrew-sw.js") &&
                                            -1 == t[o].active.scriptURL.indexOf("push-worker.js") &&
                                            -1 == t[o].active.scriptURL.indexOf("sw.js") &&
                                            -1 ==
                                            t[o].active.scriptURL.indexOf("service-worker.js") &&
                                            -1 ==
                                            t[o].active.scriptURL.indexOf(
                                                "pushwoosh-service-worker.js"
                                            ) &&
                                            -1 ==
                                            t[o].active.scriptURL.indexOf("serviceworker.js") &&
                                            -1 ==
                                            t[o].active.scriptURL.indexOf(
                                                B + "-push-worker-fb.js"
                                            )) ||
                                        t[o].unregister().then(function() {
                                            navigator.serviceWorker
                                                .getRegistration()
                                                .then(function(t) {
                                                    void 0 !== t ?
                                                        (-1 ==
                                                            t.active.scriptURL.indexOf(
                                                                "OneSignalSDKWorker.js"
                                                            ) &&
                                                            -1 ==
                                                            t.active.scriptURL.indexOf(
                                                            ...
                                                            -1 == t.active.scriptURL.indexOf("sw.js") &&
                                                            -1 ==
                                                            t.active.scriptURL.indexOf(
                                                                "service-worker.js"
                                                            ) &&
    ...
    (this.checkLocalSubsctoption = function(e, t, o, i) {
        oSpP.log("[DD] subscribe :: subscriptionId: " + e),
            oSpP.getDbValue("SPIDs", "SubscriptionId", function(i) {
                void 0 === i.target.result ?
                    (oSpP.sendSubscribeDataToServer(e, "subscribe", void 0, t, o),
                        oSpP.putValueToDb("SPIDs", { type: "SubscriptionId", value: e })) :
                    i.target.result.value !== e &&
                    (oSpP.sendSubscribeDataToServer(
                            i.target.result.value,
                            "unsubscribe"
                        ),
                        oSpP.sendSubscribeDataToServer(e, "subscribe", void 0, t, o),
                        oSpP.putValueToDb("SPIDs", { type: "SubscriptionId", value: e }));
    ...
    (this.sendSubscribeDataToServer = function(e, t, o, i, s) {
        ...
        a &&
            ...
            (((o = {}).uname = oSpP.checkCookie("lgn")),
                (o.os = oSpP.detectOs())),
            void 0 === i && (i = ""),
            (o.variables = a && !F ? A : oSpP.getUserVariables());
        var p,
    ...
    (this.initDb = function(e) {
        if (f) e();
            ...
            var t = (
                ...
                window.msIndexedDB
            ).open(R.toLowerCase() + "_push_db", 2);
            (t.onsuccess = function(t) {
                (f = t.target.result), e();
            }),
            (t.onupgradeneeded = function(e) {
                e.target.result.createObjectStore("SPIDs", { keyPath: "type" });
            });
        }
    }),
    ...
    (this.showPopUp = function() {
        ...
        "" == p && (p = "en"),
            (I = window.open(
                s + "/" + p + "/" + g + "/" + r,
                "_blank",
                "scrollbars=yes, width=580, height=580, top=" + a + ", left=" + n
            )),
            ...
            P ? oSpP.closePrompt(!0) : F || oSpP.closePrompt(!0);
    }),
    (this.closePrompt = function(e) {
        void 0 === e && oSpP.sendPromptStat("prompt_closed"),
            document.getElementsByClassName(B + "-prompt").length > 0 &&
            document.body.removeChild(
                document.querySelector("." + B + "-prompt")
            ),
            document.getElementsByClassName(B + "-prompt-backdrop").length > 0 &&
            document.body.removeChild(
                document.querySelector("." + B + "-prompt-backdrop")
            ),
    ...
    (this.sendUpdatesToServer = function(e) {
        ...
        var i = {
            ...
            appkey: g,
            sPushHostHash: r,
            custom_data: { variables: T },
        };
        o.send(JSON.stringify(i));
    }),
    (this.sendPromptStat = function(e) {
        "prompt_denied" === e &&
            oSpP.putValueToDb("SPIDs", { type: "SubscriptionId", value: "denied" });
    }),
    (this.showhelpPromptText = function() {
        ...
        if (
            ...
            o.setAttribute("class", B + "-backdrop-info"),
            ...
            if (((i.os = t.getOS().name), void 0 !== H && 0 == H && (e = !1), e)) {
                ...
                if (document.getElementsByClassName(B + "-backdrop-info").length) {
                    ...
                    r.setAttribute("style", "display:none"),
                        r.setAttribute(
                            "class",
                            B + "-webpush-label " + a + " " + c + " " + p + " " + l
                        ),
                        r.setAttribute("onclick", "this.remove();");
                    var d = document.createElement("div");
                    if (
                        (d.setAttribute("class", B + "-inner-content"),
                            (d.innerHTML += s),
                            "chrome" === i.name.toLowerCase())
                    ) {
    ...
    (this.getPushHintDiv = function() {
        ...
        return (
            n.setAttribute("class", B + "-prompt-message-text"),
            (n.innerHTML = Z[e]),
            o.appendChild(i),
            o.appendChild(n),
            t.appendChild(o),
    ...
    (this.showCustomPrompt = function() {
        ...
        if (
            ...
            (i = (e = JSON.parse(b)).style) === B + "-popover" &&
                (i = B + "-native-popover");
            var l = document.createElement("div"),
                u = B + "-prompt " + i;
            l.setAttribute("class", u),
                e.backgroundcolor.length > 0 &&
                i != B + "-fab" &&
            ...
            if (
                (S.setAttribute("class", B + "-bell-icon"),
                    S.setAttribute("width", "14"),
                    S.setAttribute("height", "14"),
                    S.setAttribute("src", "https://" + p + "/img/push/icon-ring.svg"),
                    s)
            ) {
                var m = document.createElement("span");
                m.setAttribute("class", B + "-link-wrapper"),
            ...
            if (i === B + "-native-popover") {
                ...
                l.setAttribute("style", r),
                    ...
                    ((u += " " + B + "-pos-" + e.custom.prompt_position),
                        l.setAttribute("class", u)),
                    (C = document.createElement("div")).setAttribute(
                        "class",
                        B + "-native-info-inner " + B + "-table-wrapper"
                    );
                var v = document.createElement("div");
                v.setAttribute("class", B + "-cell"),
                    S.setAttribute("src", "https://" + p + e.icon),
                ...
                M.setAttribute(
                        "class",
                        B + "-prompt-info " + B + "-prompt-message-text"
                    ),
                    (M.innerHTML += w),
                    f.appendChild(M),
                    C.appendChild(v),
                ...
                if (
                    ((C = document.createElement("div")).setAttribute(
                            "class",
                            B + "-prompt-title " + B + "-prompt-message-text"
                        ),
                        e.textcolor.length > 0 &&
                        C.setAttribute("style", "color: " + e.textcolor + " !important;"),
                        (C.innerHTML = h),
                        ...
                        e.textcolor.length > 0 &&
                        I.setAttribute("style", "color: " + e.textcolor + " !important;"),
                        (I.innerHTML += w),
                        void 0 !== e.custom &&
                    ...
                    l.setAttribute("class", u),
                        ...
                        C.setAttribute("class", B + "-table-wrapper");
                    ...
                    N.setAttribute("class", B + "-prompt-label"),
                        (L = document.createElement("a")).setAttribute("href", V),
                        L.setAttribute("target", "_blank"),
                        ((g = document.createElement("span")).innerHTML = Y[n]),
                        L.appendChild(g),
                        N.appendChild(L);
                } else {
                    var x = document.createElement("div");
                    x.setAttribute("class", B + "-prompt-fab " + B + "_notify_prompt"),
                        x.setAttribute(
                            "onclick",
                ...
                void 0 !== e.custom &&
                    void 0 !== e.custom.prompt_position &&
                    ((u += " " + B + "-fab-" + e.custom.prompt_position),
                        l.setAttribute("class", u));
            ...
            if (i != B + "-fab") {
                ...
                j.setAttribute(
                        "class",
                        B + "-prompt-btn " + B + "-accept-btn " + B + "_notify_prompt"
                    ),
                ...
                if (
                    (k.setAttribute("class", B + "-prompt-btn " + B + "-disallow-btn"),
            ...
            if (
                (d.appendChild(C),
                    ...
                    (l.appendChild(d), s && void 0 !== N && l.appendChild(N)) :
                    (s && void 0 !== m && d.appendChild(m),
                        l.appendChild(d),
                        l.appendChild(x)),
                    i != B + "-fab")
            ) {
                var Q = document.createElement("button");
                Q.setAttribute("class", B + "-prompt-close"),
                    Q.setAttribute(
                        "onclick",
            ...
            if (
                ...
                G.setAttribute("class", B + "-prompt-backdrop"),
    ...
    (this.closeCustomPrompt = function(e) {
        oSpP.sendPromptStat("prompt_closed"),
            null !== document.body.querySelector("." + B + "-prompt") &&
            document.body.querySelector("." + B + "-prompt").remove(),
            oSpP.closePromptHelpText(!0),
            e && oSpP.putValueToDb("SPIDs", { type: "PromptClosed", value: 5 });
    }),
    (this.showHintDiv = function() {
        if (F && "chrome" === c.name.toLowerCase()) {
            ...
            e.setAttribute(
                    "class",
                    B + "-prompt " + B + "-hint-popover show-prompt " + B + "-secure-mode"
                ),
    ...
    (this.hideHintDiv = function() {
        document.getElementsByClassName(B + "-hint-popover").length &&
            document.querySelector("." + B + "-hint-popover").remove();
    }),
    (this.closePromptHelpText = function(e) {
        null !== document.querySelector("." + B + "-backdrop-info") &&
            document.querySelector("." + B + "-backdrop-info").remove(),
            e &&
            (oSpP.sendPromptStat("prompt_closed"),
                oSpP.putValueToDb("SPIDs", { type: "PromptClosed", value: 5 }));
    }),
    (this.closePushLabel = function() {
        null !== document.querySelector("." + B + "-bottom-push-label") &&
            document.querySelector("." + B + "-bottom-push-label").remove(),
            null !== document.querySelector("." + B + "-webpush-label") &&
            document.querySelector("." + B + "-webpush-label").remove();
    }),
        ...
        if (parseInt(Q) > 0)
            var t = setInterval(function() {
                oSpP.getDbValue("SPIDs", "PromptDelay", function(o) {
                    void 0 !== o.target.result ?
                        new Date().getTime() >= o.target.result.value &&
                        (clearInterval(t), e()) :
                        (clearInterval(t), e());
                });
            }, 1e3);
    ...
    (this.getVisitsCount = function() {
        ...
        oSpP.getDbValue("SPIDs", "VisitsCount", function(t) {
            void 0 === t.target.result ?
                (oSpP.putValueToDb("SPIDs", { type: "VisitsCount", value: e }),
                    e >= oSpP.getSettingsShowByVisitNumber() &&
                    oSpP.checkIsServiceWorkerExitsAndInitPrompt(!1)) :
...
window.addEventListener("load", function() {
    -1 ===
        ...
        .clearDomain(window.location.href.toLowerCase())
        .indexOf(oSpP.clearDomain(oSpPOptions.sPushSubSomain.toLowerCase())) ?
        oSpP.checkIsServiceWorkerExitsAndInitPrompt(!0) :
        oSpP.getSettingsShowByVisitNumber() > 1 ?
        oSpP.getVisitsCount() :
        oSpP.checkIsServiceWorkerExitsAndInitPrompt(!1);
});
